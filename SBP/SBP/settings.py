...
SECRET_KEY = 'django-insecure-spw1@!3(iqz^$e!=ua4wl58li*c*!b$61&)+dazcgw7k8jylg%'
...
# Разрешите куки и авторизационные заголовки
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'connect_timeout': 15,  # Таймаут подключения 5 секунд
        },
...
AUTH_USER_MODEL = 'win.User'  # Замените yourapp на имя вашего приложения
